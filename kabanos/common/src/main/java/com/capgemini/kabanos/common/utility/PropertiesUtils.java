...
public class PropertiesUtils {
	...
	public static final String[] projectProperties = { PROJECT_NAME, PROJECT_DESCRIPTION, TEST_FRAMEWORK };

	public static final String DB_URL = "dbUrl";
	public static final String DB_USER = "dbUser";
	public static final String DB_PSWD = "dbPassword";
	public static final String[] databaseParams = { DB_URL, DB_USER, DB_PSWD };
	...
	public static final String[] gathererParams = { LOGGER_PREFIX, LOGGER_SUFFIX, LOGGER_STEP_REGEX };
	...
	public static final String[] jiraParams = { JIRA_URL, JIRA_USER, JIRA_PASSWORD, JIRA_TEST_START_LINE,
